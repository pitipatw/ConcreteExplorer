...
additional_path = "15_03_FullScaleTestDemands//" #for more specific task
...
for i in eachindex(all_files) 
    ...
    demand_path = joinpath(@__DIR__, demand_folder*filename*".json");
